...
from src.library.UIComponents.Components import Button, UIGroup
from src.library.UIComponents.UIComponentFactory import UIComponentFactory
from src.library.UIComponents.draggable import makeDraggable
from src.library.UIComponents.generalUI import WHITE, BLUE
...
line = UIComponentFactory().drawLine(button1.center, button2.center).defaultColor().build()
line.width = 10
